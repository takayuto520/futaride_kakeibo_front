...
- **Primary**: 青色系 (#3b82f6) - メインアクション、ヘッダー
- **Primary-light**: 薄い青色系 (#dbeafe) - ホバー状態
- **Secondary**: グレー系 (#6b7280) - テキスト、背景
- **Secondary-light**: 薄いグレー系 (#f5f5f5) - 軽い背景
- **Accent**: 赤色系 (#ef4444) - エラー、支出
- **Accent-light**: 薄い赤色系 (#fecaca) - 軽いアクセント
